    ...
    public static void main(String[] args) {
        Double ratings[][] = {
            /*
                ...
                ...
             */
            {5.0, 4.0, null, 2.0, 2.0},
            {5.0, null, 4.0, 2.0, 0.0},
            {2.0, null, 1.0, 3.0, 4.0},
            {0.0, 0.0, null, 4.0, null},
            {1.0, null, null, 4.0, null},
            {null, 2.0, 1.0, null, null},
            {null, null, 1.0, 4.0, 5.0}
        };
        ...
        System.out.println("Ma trận độ tương tự giữa các user:");
        ...
        System.out.println("\nVector độ tương tự user " + u + " với các user #: ");
...
//                    System.out.println(key + " " + sortRatingAndUser.get(key));
                ...
                System.out.println("\nAverage User " + u + " and Predict Rating / 5: ");
        ...
        System.out.println("");
        System.out.println("Ma trận dự đoán rating cho user " + u);
